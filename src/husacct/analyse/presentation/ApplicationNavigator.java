	...
	public void valueChanged(TreeSelectionEvent e) {
    	...
    	DefaultMutableTreeNode node = (DefaultMutableTreeNode) tree.getLastSelectedPathComponent();
				...
				if (node.isLeaf()) {
				 ...
				 String[] splitNode =  node.toString().split("\\.");
				 
				 String tempName= "";
				 String tempBelongsTo = "";
				 
				 if(splitNode.length > 0){
					int counter =0;
					 for(String s: splitNode){ 	 
						 counter++; 
						 if(counter == 1){
							 tempBelongsTo += s + ".";
						 }
				 ...
				 else
				 {
				    ...
				    final String inputValue = node.toString();   
					...
					addDependency(new DependencyDTO("domain.locationbased.latitude.Map", "infrastructure.socialmedia.locationbased.latitude.IMap", "implements", 10));
	        			 ...
	        			 ArrayList<DependencyDTO> listDepend = new ArrayList<DependencyDTO> ();
	        			 listDepend.add(new DependencyDTO("domain.locationbased.foursquare.History", "infrastructure.socialmedia.locationbased.foursquare.HistoryDAO", "extends", 10));
	        			 
	        			 addDependency(new DependencyDTO("domain.locationbased.foursquare.History", "infrastructure.socialmedia.locationbased.foursquare.HistoryDAO", "extends", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.latitude.Account", "infrastructure.socialmedia.locationbased.latitude.AccountDAO", "object", 11));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.latitude.Friends", "infrastructure.socialmedia.locationbased.latitude.FriendsDAO", "extends", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.foursquare.Map", "infrastructure.socialmedia.locationbased.foursquare.IMap", "extends", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.foursquare.Account", "infrastructure.socialmedia.locationbased.foursquare.AccountDAO", "object", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.foursquare.Friends", "infrastructure.socialmedia.locationbased.foursquare.FriendsDAO", "extends", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.foursquare.Friends", "infrastructure.socialmedia.locationbased.foursquare.AccountDAO", "implements", 10));
	        			 listDepend.add(new DependencyDTO("domain.locationbased.latitude.Map", "infrastructure.socialmedia.locationbased.latitude.IMap", "implements", 10));
	        			 
	        			 SortedListModelV2 checkModel = new SortedListModelV2();
     					
	        			 for(DependencyDTO currDependency: listDepend){
	        					
	        				 if(currDependency.from.equalsIgnoreCase(inputValue)){
   
	        					 checkModel.add(currDependency.to); 
	        				 } 
	        				 
	        			 }
	        			 jList2.setModel(checkModel); 
	        		
						 SortedListModelV2 modelList1 = new SortedListModelV2();
						 modelList1.add(inputValue);
...
//					 SortedListModelV2 checkModel = new SortedListModelV2();
//					 checkModel.add(node.toString());
//					 checkModel.add("");
					
					
//					 SortedListModelV2 checkModel = new SortedListModelV2();
//					 checkModel.add(new DTOtest("aa","aa"));
//					
//					 jTable1.setModel(checkModel);
					...
					jTable1.setModel(new javax.swing.table.DefaultTableModel(
				                new Object [][] {
				                    ...
				                    {"BelongsToPackage", tempBelongsTo} 
				                },
				                new String [] {
				                    "Property", "Value"
				                }
...
//            	 JOptionPane.showInputDialog("huh", "Hoi");
            	 
            	 
                 IAnalyseService analyseService = new AnalyseServiceImpl(); 
                 analyseService.analyseApplication();
                 
                 analyseService.getRootModules();
                 
                 
                 
                 
                 for(AnalysedModuleDTO a: analyseService.getRootModules()){
                	 System.out.println("a.uniquename = "+a.uniqueName);
                   	 System.out.println("a.name = "+a.name);
                   	 System.out.println("a.type = "+a.type);
//                	 analyseService.getChildModulesInModule(a.uniqueName);
                	 
                	 
                	 
//                	 for(AnalysedModuleDTO classesInPackage: analyseService.getChildModulesInModule(a.uniqueName)){
//                		 System.out.println("classesInPackage.uniquename = "+classesInPackage.uniqueName);
//                	 }
                 }
